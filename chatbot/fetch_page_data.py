#!/usr/bin/env python3
"""
Script to fetch data for a single page and store it in the database.
Usage: python fetch_page_data.py <page_id>
"""
...
if len(sys.argv) < 2:
    print("Usage: python fetch_page_data.py <page_id>")
    sys.exit(1)
...
# Fetch and store data for the page
